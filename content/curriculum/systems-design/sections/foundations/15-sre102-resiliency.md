...
Learn design patterns for resiliency using a vetted, open-licensed reference and apply it in interview-style design discussions.

## Core concepts

```mermaid
flowchart TD
  A["Design Patterns for Resiliency"] --> B["Key_components"]
  B --> C["Tradeoffs"]
```
