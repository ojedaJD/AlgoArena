...
Learn system design (phase 2 intro) using a vetted, open-licensed reference and apply it in interview-style design discussions.

## Core concepts

```mermaid
flowchart TD
  A["System Design (Phase 2 Intro)"] --> B["Key_components"]
  B --> C["Tradeoffs"]
```
